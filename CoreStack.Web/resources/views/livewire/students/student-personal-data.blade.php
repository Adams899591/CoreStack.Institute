<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
        ...
        <div class="px-8 pb-8 flex flex-col md:flex-row items-end -mt-12 space-y-4 md:space-y-0 md:space-x-6 relative z-10">
            <div class="relative">
                <img src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200&h=200&auto=format&fit=crop" 
                     class="w-32 h-32 rounded-2xl border-4 border-white shadow-md object-cover" alt="Profile">
            ...
            <div class="flex space-x-3 pb-2">
                <button class="px-5 py-2.5 bg-stone-100 hover:bg-stone-200 text-stone-700 font-bold rounded-xl transition text-[10px] uppercase tracking-widest">
                    Request Edit
                </button>
                <button class="px-5 py-2.5 bg-gold hover:bg-gold-dark text-white font-bold rounded-xl transition text-[10px] uppercase tracking-widest shadow-sm">
                    Download ID Card
                </button>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-stone-100 bg-stone-50/50">
                    <h2 class="font-bold text-stone-800 text-sm flex items-center">
                        <svg class="w-5 h-5 mr-2 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 014 0"></path></svg>
                        Personal Biography
                    </h2>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-stone-100 bg-stone-50/50">
                    <h2 class="font-bold text-stone-800 text-sm flex items-center">
                        <svg class="w-5 h-5 mr-2 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        Contact Information
                    </h2>
                </div>
        ...
        <div class="space-y-6">
            <div class="bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-stone-100 bg-darkblue text-white">
                    <h2 class="font-bold text-sm flex items-center">
                        <svg class="w-5 h-5 mr-2 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"></path></svg>
                        Academic Record
                    </h2>
                </div>
                <div class="p-6 space-y-5">
                    ...
                    <div class="flex justify-between items-center pb-3 border-b border-stone-50">
                        ...
                        <span class="text-stone-800 font-bold text-xs uppercase">Computing</span>
                    </div>
                    <div class="flex justify-between items-center pb-3 border-b border-stone-50">
                    ...
                    <div class="pt-2">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-[10px] font-bold text-stone-400 uppercase tracking-tighter">Profile Completion</span>
                            <span class="text-xs font-black text-gold">92%</span>
                        </div>
                        <div class="w-full bg-stone-100 h-2 rounded-full overflow-hidden">
                            <div class="bg-gold h-full rounded-full transition-all duration-1000" style="width: 92%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-indigo-50 border border-indigo-100 rounded-2xl p-6 relative overflow-hidden">
                <div class="relative z-10">
                    <h3 class="text-indigo-900 font-bold text-sm mb-1">Safety First</h3>
                    <p class="text-indigo-600/80 text-[10px] leading-relaxed mb-4">Ensure your Next of Kin details are updated annually to remain compliant with institute policies.</p>
                    <a href="#" class="text-[10px] font-bold text-indigo-700 hover:text-indigo-900 uppercase tracking-widest flex items-center">
                        Update Details
                        <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                    </a>
                </div>
                <svg class="absolute -right-4 -bottom-4 w-24 h-24 text-indigo-500/10" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"></path></svg>
            </div>
        </div>
    </div>
</div>
