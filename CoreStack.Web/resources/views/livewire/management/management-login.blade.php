<div class="flex items-center justify-center min-h-screen bg-cover bg-center bg-no-repeat" style="background-image: url('https://images.unsplash.com/photo-1554460777-a8ac1f71f65f?q=80&w=1600&auto=format&fit=crop');">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm text-center">
        ...
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Management Login</h2>
        ...
        <form wire:submit.prevent="login" class="space-y-4">
            ...
            <div class="text-left">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        id="username"
                        wire:model="username"
                        class="shadow appearance-none border rounded-md w-full py-2 pl-10 pr-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('username') border-red-500 @enderror"
                        required
                        autofocus
                    >
                </div>
            ...
            <div class="flex items-center justify-between text-sm">
                <label class="flex items-center">
                    <input type="checkbox" wire:model="remember" class="form-checkbox h-4 w-4 text-[#1A2B4C] transition duration-150 ease-in-out">
