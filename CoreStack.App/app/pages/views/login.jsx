    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          <Text style={styles.title}>CoreStack</Text>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity style={styles.forgotBtn} onPress={() => router.push('/(tabs)/home')}>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 40, fontWeight: '900', color: colors.darkBlue, trackingTight: -1.5 },
